    ...
    <body>
        ...
        <form id = "profileForm" method = "post">
            ...
            <table id = "profileTable">
                <tr>
                    <td><button type="submit" value = "logout" class = "interface" name = "logout"> Log out </button></td>
                    <td><button type="submit" value = "delete" class = "interface" name = "delete" onclick = "ajaxFunction($server, $userID, $pwd, $dbName)"> Delete Account </button></td>
                </tr>
            </table>
        </form>
    </body>
